...
namespace CitiesSkylines2Mod
{
    public sealed partial class GameQueryService
    {
        ...
        {
            RequirePaused(world); var e = StableHousehold((string)args["household_id"], world); var em = world.EntityManager; var h = em.GetComponentData<Household>(e); var before = HouseholdJson(e, world); if (args["consumable_resources"] != null) h.m_Resources = (int)args["consumable_resources"]; if (args["consumption_per_day"] != null) h.m_ConsumptionPerDay = (short)(int)args["consumption_per_day"]; if (args["shopping_today"] != null) h.m_ShoppedValuePerDay = (uint)args["shopping_today"]; if (args["shopping_last_day"] != null) h.m_ShoppedValueLastDay = (uint)args["shopping_last_day"]; if (args["salary_last_day"] != null) h.m_SalaryLastDay = (int)args["salary_last_day"]; if (args["leveling_spend_last_day"] != null) h.m_MoneySpendOnBuildingLevelingLastDay = (int)args["leveling_spend_last_day"]; em.SetComponentData(e, h); return new JObject { ["before"] = before, ["after"] = HouseholdJson(e, world) };
        }
