...
当前代码版本 **1.19.0**：329 个 MCP 工具，29 个实体查询分类。`plan_building_workflow`、`execute_building_plan`、`cancel_building_plan` 和 `deploy_building_plans` 将四类建筑的发现、选址、候选回退、原生预览、影响分析、提交与实体回读固定为高层流程；详细用法见 [建筑指南](../BUILDING-GUIDE.md)。灾害功能见 [灾害指南](../DISASTER-GUIDE.md)。城市名称、配置、全市政策、资金、城市修正值和统计历史见 [城市管理指南](../CITY-MANAGEMENT-GUIDE.md)。树木、植物、水源、污染、天气覆盖、风场和土壤水见 [环境与景观指南](../ENVIRONMENT-LANDSCAPE-GUIDE.md)。地图格、地图边界、气候、资源、可建设面积和扩张购买见 [地图和区域指南](../MAP-AREA-GUIDE.md)。车辆、Traveler、市民行程、交通流、停车、目标、速度、重寻路与车辆清理见 [交通与出行控制指南](../TRAFFIC-MOBILITY-GUIDE.md)。道路接口覆盖创建、平行道路与避障、环路、自动接入既有路网的分级街区、自动路径、四匝道立交、反向、升级、拆除、分区格、原生停车变体、道路装饰、车道/交通读取、路口控制、道路/车道策略及安全撤销，见 [铺路指南](../ROAD-GUIDE.md)。分区接口支持区域枚举、逐格分析、左右侧与深度筛选、批量划区、替换和清除，见 [分区指南](../ZONING-GUIDE.md)。行政区接口支持创建、边界替换、删除、命名、政策和服务覆盖范围，见 [行政区指南](../DISTRICT-GUIDE.md)。公共交通线路支持原生寻路预览、创建、完整站序替换、命名、颜色、启停、班表、票价、车辆数、编号、均匀发车、车辆请求、运营车辆返场、状态读取和删除，见 [公共交通线路指南](../TRANSPORT-GUIDE.md)；公共交通基础设施支持车站/车辆段的规划、放置、移动、命名、启停、政策、升级和拆除，以及火车、地铁、电车轨道创建、既有节点/边连接和批量拆除，见 [公共交通基础设施指南](../TRANSPORT-INFRASTRUCTURE-GUIDE.md)。公共设施与管网支持电力、供水、污水、通信设施及独立管网的读取、选址、放置、移动、升级、连接和拆除，见 [公共设施与管网指南](../UTILITY-INFRASTRUCTURE-GUIDE.md)。13 类城市公共服务设施支持预设发现、实例状态、选址、放置、移动、升级和拆除，见 [城市公共服务设施指南](../CITY-SERVICE-GUIDE.md)。城市经济、税率、服务预算、服务费与贷款见 [城市经济管理指南](../ECONOMY-GUIDE.md)。人口、住房、就业、教育与分区需求见 [城市发展与需求指南](../DEVELOPMENT-GUIDE.md)。XP、里程碑、发展树与原生解锁见 [城市进度与解锁指南](../PROGRESSION-GUIDE.md)。市民、家庭、企业与资源物流见 [人口与资源经济指南](../POPULATION-ECONOMY-GUIDE.md)。地形接口见 [地形指南](../TERRAIN-GUIDE.md)。数据查询见 [扩展查询指南](QUERY-GUIDE.md) 和 [深层查询指南](../DEEP-QUERY-GUIDE.md)。Blob 原始字节导出已实现，但尚未取得真实实例验证；并非全部游戏数据都已解码。
