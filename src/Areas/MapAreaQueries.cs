...
namespace CityWeaver
{
    ...
    public sealed partial class GameQueryService
    {
        ...
        private MapTileOperation PreviewMapTilePurchase(JObject args, World world)
        {
            ...
            if (m_MapTileOperations.Count >= 4096) throw new QueryException("MAP_TILE_OPERATION_LIMIT", "This city session has reached 4096 map-tile operations."); var em = world.EntityManager; var selected = new List<Entity>();
